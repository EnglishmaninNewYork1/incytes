...
var email = "autotest.incytes+-2@gmail.com"
var phonecode = "7901"
var teamname = "AutotestTeam"
var defaultpatientmail = "autotest.incytes+m"
...
describe('E2E Test', function () {
    ...
    it("Clinician TeamPhoneNumberChange", () => {
    ...
    it("Clinician CaseCreate", () => {

        cy.viewport(1920, 1080)
        cy.reload()
        cy.get("input[name = 'email']").should('exist', 'be.visible').type(email)
        cy.get("input[name = 'password']").should('exist', 'be.visible').type(password)                   // Relogin
        cy.get("button[data-testid = 'form-login-button-login']").should('exist', 'be.visible').click()


        cy.get("div[data-testid = 'left-navigation-top']").should('exist').and('be.visible')
        cy.get("div[data-testid = 'left-nav-button-cases']").click()
    ...
    it("Clinician FillSurvey", () => {
        ...
        cy.wa
        cy.get("div[data-testid = 'left-nav-button-tasks']").should('exist').and('be.visible').click()
    })

    it("Clinician Tasks Check", () => {
        ...
        cy.get("span").contains('Patient').click()
        cy.wait(3000)
        cy.get("tr[data-testid = 'mytasks-row']").should('exist').and('be.visible')
        
    })

    it("Clinician Report Building", () => {
        ...
        cy.get("button[data-testid = 'build-report-button']").should('exist').and('be.visible').click()
        ...
        cy.get("div[data-testid = 'report-builder-circle-select']").should('exist').and('be.visible').click()
        ...
        cy.get("button[data-testid = 'report-builder-button-export']").should('exist').and('be.visible').click()
        cy.wait(10000)
